const Ticker = function(t) {
    ...
    Stage = function(t, e, i) {
        ...
        function s(i) {
            ...
            s.stages.push(this), this._listeners = {
                resize: [],
                pointerstart: [],
                pointermove: [],
                pointerend: [],
        ...
        return s.stages = [], s.disableHighDPI = !1, s.prototype.addEventListener = function(t, e) {
            try {
            ...
            return {
                x: (e - n.left) * (t.width / n.width),
                y: (i - n.top) * (t.height / n.height)
            }
        }, s.mouseHandler = function(t) {
            if (Date.now() - n < 500) return;
            let e = "start";
            "mousemove" === t.type ? e = "move" : "mouseup" === t.type && (e = "end"), s.stages.forEach(i => {
            ...
            n = Date.now();
            let e = "start";
            "touchmove" === t.type ? e = "move" : "touchend" === t.type && (e = "end"), s.stages.forEach(i => {
        ...
        }, e.addEventListener("mousedown", s.mouseHandler), e.addEventListener("mousemove", s.mouseHandler), e.addEventListener("mouseup", s.mouseHandler), e.addEventListener("touchstart", s.touchHandler), e.addEventListener("touchmove", s.touchHandler), e.addEventListener("touchend", s.touchHandler), s
